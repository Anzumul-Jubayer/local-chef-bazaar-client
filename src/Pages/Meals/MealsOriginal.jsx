...
const Meals = () => {
  ...
  const [chefExperienceFilter, setChefExperienceFilter] = useState(""); // Field 3: Chef Experience
  ...
  useEffect(() => {
    const fetchFilterOptions = async () => {
      try {
        // Fetch unique areas for filter dropdowns
        const areasRes = await fetch("https://local-chef-bazaar-server-hazel.vercel.app/meals/areas");
        ...
        await withLoading(async () => {
          const queryParams = new URLSearchParams({
            ...
            ...(chefExperienceFilter && {
              minExperience: chefExperienceFilter,
            }),
          });

          const res = await fetch(`https://local-chef-bazaar-server-hazel.vercel.app/meals?${queryParams}`);
  ...
  const sortOptions = [
    {
      ...
      description: "Sort by meal price",
    },
  ];
  ...
  const experienceOptions = [
    {
      ...
      description: "Chefs with any level of experience",
    },
    {
      value: "0.5",
      label: "6+ Months",
      description: "New chefs with some experience",
    },
    { value: "1", label: "1+ Years", description: "Experienced home chefs" },
    { value: "3", label: "3+ Years", description: "Seasoned chefs" },
    { value: "5", label: "5+ Years", description: "Expert chefs" },
    { value: "10", label: "10+ Years", description: "Master chefs" },
  ];
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted">
                    Arrange meals by your preference
                  </p>
                </div>
              </div>
                ...
                <div className="min-w-[220px]">
                  ...
                  <div className="relative group">
                    <select
                      ...
                      className="w-full px-4 pr-12 py-4 bg-background/50 border border-primary/20 hover:border-primary/40 focus:border-primary/60 rounded-xl transition-all duration-300 focus:outline-none appearance-none cursor-pointer font-medium shadow-sm hover:shadow-md text-base-content group-hover:bg-background/70"
                    >
                    ...
                    <div className="absolute right-4 top-1/2 transform -translate-y-1/2 flex items-center space-x-2 pointer-events-none">
                      ...
                      <HiChevronDown className="w-5 h-5 text-muted group-hover:text-primary transition-colors" />
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        <HiTag className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-muted group-hover:text-accent transition-colors" />
                        <select
                      ...
                      <p className="text-xs text-muted mt-1">
                        {categoryFilter
                          ? `Showing ${categoryFilter} cuisine`
                ...
                >
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="relative group">
                          <input
                            ...
                            className="w-full px-3 py-3 bg-background/50 backdrop-blur-sm border border-secondary/30 hover:border-secondary/50 focus:border-secondary rounded-xl transition-all duration-300 focus:outline-none text-center font-medium group-hover:bg-background/70"
                          />
                          <span className="absolute left-2 top-1/2 transform -translate-y-1/2 text-xs text-muted">
                            ৳
                          </span>
                        </div>
                        <div className="relative group">
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        <HiStar className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-yellow-400 group-hover:text-yellow-500 transition-colors" />
                        <select
                          value={ratingFilter}
                          onChange={(e) => setRatingFilter(e.target.value)}
                          className="w-full pl-12 pr-10 py-3 bg-background/50 backdrop-blur-sm border border-secondary/30 hover:border-secondary/50 focus:border-secondary rounded-xl transition-all duration-300 focus:outline-none appearance-none cursor-pointer font-medium group-hover:bg-background/70"
                        >
                        ...
                        <HiChevronDown className="absolute right-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-muted pointer-events-none group-hover:text-secondary transition-colors" />
                      </div>
                      <p className="text-xs text-muted mt-1">
                        {ratingFilter
                          ? `Showing meals rated ${ratingFilter}+ stars`
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        <HiSparkles className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-primary group-hover:text-primary/80 transition-colors" />
                        <select
                          value={chefExperienceFilter}
                          onChange={(e) =>
                            setChefExperienceFilter(e.target.value)
                          }
                      ...
                      <p className="text-xs text-muted mt-1">
                        {chefExperienceFilter
                          ? `Chefs with ${chefExperienceFilter}+ years experience`
                          : "Filter by chef expertise level"}
                      </p>
                    </div>
                      ...
                      <div className="flex flex-wrap gap-2 max-h-32 overflow-y-auto">
                        ...
                        {chefExperienceFilter && (
                          ...
                          >
                            ...
                            <button
                              onClick={() => setChefExperienceFilter("")}
            ...
            {meals.length === 0 ? (
              ...
              <>
                ...
                <div className="flex flex-wrap items-center gap-3 mb-6 p-4 bg-background/30 backdrop-blur-sm border border-primary/20 rounded-xl shadow-sm">
                  ...
                  {/* Popular Categories */}
                  {["Bengali", "Chinese", "Indian", "Fast Food"].map(
                    (category) => (
                      <button
                        key={category}
                        onClick={() =>
                  ...
                  {["4.5", "4", "3.5"].map((rating) => (
                    <button
                      ...
                      className={`flex items-center space-x-1 px-3 py-1.5 rounded-full text-sm font-medium transition-all duration-200 ${
                        ratingFilter === rating
                          ? "bg-yellow-500/20 text-yellow-700 border border-yellow-500/30 shadow-md"
                  ...
                  {/* Chef Experience Quick Filters */}
                  {["5", "3", "1"].map((experience) => (
                    <button
                      key={experience}
                      onClick={() =>
                        setChefExperienceFilter(
                          chefExperienceFilter === experience ? "" : experience
                        )
                      }
                      className={`flex items-center space-x-1 px-3 py-1.5 rounded-full text-sm font-medium transition-all duration-200 ${
                        chefExperienceFilter === experience
                          ? "bg-purple-500/20 text-purple-700 border border-purple-500/30 shadow-md"
                          : "bg-background/30 backdrop-blur-sm border border-primary/20 hover:border-purple-500/40 text-base-content hover:bg-background/50"
                      }`}
                    >
                      <HiSparkles className="w-3 h-3" />
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    {page > 3 && (
                      <>
                        <motion.button
                          onClick={() => setPage(1)}
                          className="px-4 py-3 bg-surface border border-gray-200 hover:border-primary text-base-content hover:text-primary font-medium rounded-xl transition-all duration-300"
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                        >
                          1
                  ...
                  <div className="flex items-center justify-center mt-6 space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        className="w-20 px-3 py-2 bg-surface border border-gray-200 hover:border-primary focus:border-primary rounded-lg transition-colors focus:outline-none text-center"
                      />
