...
const ManageRequests = () => {
  ...
  const handleAccept = async (request) => {
    try {
      const res = await fetch(
        `https://local-chef-bazaar-server-flame.vercel.app/role-requests/${request._id}/accept`,
        {
          method: "PATCH",
  ...
  const handleReject = async (request) => {
    try {
      const res = await fetch(
        `https://local-chef-bazaar-server-flame.vercel.app/role-requests/${request._id}/reject`,
        {
          method: "PATCH",
        }
      );
